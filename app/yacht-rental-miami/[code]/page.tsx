                  ...
                  {pricingRates.map((rate) => {
                    ...
                    return isInstantBooking ? (
                      <button
                        ...
                        className="w-full bg-white text-[#0f0f0f] py-4 hover:bg-[#c4a265] hover:text-white hover:border-[#c4a265] transition-all duration-300 border border-[#0f0f0f]/20 flex flex-col items-center gap-1"
                      >
