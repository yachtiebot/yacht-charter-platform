            ...
            <div className="lg:col-span-2">
              ...
              <div className="lg:hidden mb-12 bg-white border border-[#0f0f0f]/10 p-10 shadow-sm">
                  ...
                  {pricingRates.map((rate) => {
                    ...
                    return isInstantBooking ? (
                      <button
                        ...
                        className="w-full bg-white text-[#0f0f0f] text-sm uppercase tracking-[0.2em] font-medium py-4 hover:bg-[#c4a265] hover:text-white hover:border-[#c4a265] transition-all duration-300 border border-[#0f0f0f]/20"
                      >
                ...
                <a
                  ...
                  className="w-full bg-white text-[#0f0f0f] text-sm uppercase tracking-[0.2em] font-medium py-4 hover:bg-[#c4a265] hover:text-white hover:border-[#c4a265] transition-all duration-300 mb-4 flex items-center justify-center gap-3 border border-[#0f0f0f]/20"
                >
                ...
                <button
                  ...
                  className="w-full bg-white text-[#0f0f0f] text-sm uppercase tracking-[0.2em] font-medium py-4 hover:bg-[#c4a265] hover:text-white hover:border-[#c4a265] transition-all duration-300 mb-4 border border-[#0f0f0f]/20"
                >
                  EMAIL INQUIRY
                </button>
                ...
                <a
                  ...
                  className="w-full bg-white text-[#0f0f0f] text-sm uppercase tracking-[0.2em] font-medium py-4 hover:bg-[#c4a265] hover:text-white hover:border-[#c4a265] transition-all duration-300 flex items-center justify-center border border-[#0f0f0f]/20"
                >
                  CALL 1 800 747 9585
                </a>
              </div>
              ...
              <div className="mb-12 py-8 px-0 md:px-8">
