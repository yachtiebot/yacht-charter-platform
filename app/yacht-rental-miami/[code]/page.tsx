        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="lg:hidden mb-12 bg-white border border-[#e5e5e5] p-8">
                {fields['Instant Booking Enabled'] ? (
                  <>
                    <h3 className="editorial-label text-[#0f0f0f] mb-3 text-center" style={{fontWeight: 400, fontSize: '16px', letterSpacing: '0.05em'}}>
                  ...
                  {pricingRates.map((rate) => {
                    ...
                    return isInstantBooking ? (
                      <button
                        ...
                        className="w-full bg-white text-[#0f0f0f] editorial-label py-4 hover:bg-[#c4a265] hover:text-white transition-colors duration-300 border-2 border-[#0f0f0f]"
                      >
                ...
                <a
                  ...
                  className="w-full bg-white text-[#0f0f0f] editorial-label py-4 hover:bg-[#c4a265] hover:text-white transition-colors duration-300 mb-4 flex items-center justify-center gap-3 border-2 border-[#0f0f0f]"
                >
                ...
                <button
                  ...
                  className="w-full bg-white text-[#0f0f0f] editorial-label py-4 hover:bg-[#c4a265] hover:text-white transition-colors duration-300 mb-4 border-2 border-[#0f0f0f]"
                >
                  EMAIL INQUIRY
                </button>
                ...
                <a
                  ...
                  className="w-full bg-white text-[#0f0f0f] editorial-label py-4 hover:bg-[#c4a265] hover:text-white transition-colors duration-300 flex items-center justify-center border-2 border-[#0f0f0f]"
                >
                  CALL 1 800 747 9585
                </a>
              </div>
              ...
              {/* Google Review */}
              <div className="mb-12 bg-[#faf9f7] border-l-4 border-[#c4a265] p-6">
                <div className="flex items-center gap-1 mb-3">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} className="w-4 h-4 text-[#c4a265]" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  ))}
                </div>
                <p className="editorial-body text-[#0f0f0f] mb-4 italic leading-relaxed" style={{fontWeight: 400}}>
                  "{(() => {
                    const reviews = [
            ...
            <div className="hidden lg:block lg:col-span-1">
              <div className="sticky top-24 bg-white border border-[#e5e5e5] p-10 shadow-sm">
                {fields['Instant Booking Enabled'] ? (
                  <>
                  ...
                  <h3 className="editorial-label text-[#0f0f0f] mb-8" style={{fontWeight: 300, fontSize: '18px', letterSpacing: '0.05em'}}>
                    Charter Rates
                  </h3>
                )}
