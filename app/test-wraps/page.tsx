...
export default function TestWrapsPage() {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const { addItem } = useCart();

  const handleCustomizationSubmit = (customization: WrapCustomization) => {
    addItem({
      id: 'gourmet-wraps',
  ...
  return (
    <div className="min-h-screen bg-[#faf9f7] flex items-center justify-center p-8">
      <div className="text-center max-w-xl">
        ...
        <ul className="grid grid-cols-2 gap-x-8 gap-y-2 max-w-md mx-auto mb-10">
          <li className="flex items-start gap-2 text-sm text-[#6b6b6b]">
            ...
            <span style={{ fontWeight: 300 }}>up to 3 meats</span>
          </li>
          <li className="flex items-start gap-2 text-sm text-[#6b6b6b]">
            <svg className="w-4 h-4 text-[#c4a265] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            </svg>
            <span style={{ fontWeight: 300 }}>up to 3 wraps</span>
          </li>
          <li className="flex items-start gap-2 text-sm text-[#6b6b6b]">
            <svg className="w-4 h-4 text-[#c4a265] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            </svg>
            <span style={{ fontWeight: 300 }}>up to 3 cheeses</span>
          </li>
        </ul>
      ...
      <WrapCustomizationModal
        ...
        productName="Gourmet Wraps Platter"
        productPrice={89.99}
      />
    </div>
  );
