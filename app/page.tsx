            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="#" className="text-white/40 hover:text-white transition-colors" aria-label="Yelp">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.16 12.594l-4.995.772c-.293.046-.504.252-.506.543v.002c0 .293.213.54.506.545l4.995.772c.664.102 1.02-.458.801-1.078l-.003-.006c-.149-.428-.524-.653-.798-.55zm-5.025 3.152c-.255-.05-.503.194-.501.486v.002l.077 4.995c.012.759.544 1.038 1.098.677l.003-.002c.377-.245.64-.57.542-.827l-.99-5.022c-.052-.267-.228-.36-.229-.309zm-3.024-.071c.255-.05.503.194.501.486v.002l-.078 4.995c-.011.759-.543 1.038-1.097.677l-.003-.002c-.377-.245-.64-.57-.542-.827l.99-5.022c.052-.267.228-.36.229-.309zm3.024-6.102c.255.05.503-.194.501-.486v-.002l-.078-4.995c-.011-.759-.543-1.038-1.097-.677l-.003.002c-.377.245-.64.57-.542.827l.99 5.022c.052.267.228.36.229.309zM11.986 11.9l-4.995-.772c-.664-.102-1.02.458-.801 1.078l.003.006c.149.428.524.653.798.55l4.995-.772c.293-.046.504-.252.506-.543v-.002c0-.293-.213-.54-.506-.545z"/>
                  </svg>
                </a>
                <a href="#" className="text-white/40 hover:text-white transition-colors" aria-label="TripAdvisor">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm-3 14.5c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4-1.794 4-4 4zm1.5-4c0 .828-.672 1.5-1.5 1.5s-1.5-.672-1.5-1.5.672-1.5 1.5-1.5 1.5.672 1.5 1.5zm4.5 4c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4-1.794 4-4 4zm1.5-4c0 .828-.672 1.5-1.5 1.5s-1.5-.672-1.5-1.5.672-1.5 1.5-1.5 1.5.672 1.5 1.5z"/>
                  </svg>
                </a>
