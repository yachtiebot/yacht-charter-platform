    ...
    <div>
      ...
      <section className="h-screen min-h-[700px] relative flex flex-col">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end">
          <div className="max-w-[1400px] mx-auto px-6 md:px-10 w-full pb-32 md:pb-20">
        ...
        <div className="absolute bottom-0 left-0 right-0 border-t border-white/10">
          <div className="max-w-[1400px] mx-auto px-4 md:px-10 py-3 flex flex-wrap justify-between items-center gap-2">
            <div className="editorial-label text-white/40 flex flex-wrap gap-1 md:gap-2 items-center text-[7px] md:text-[11px] leading-tight">
              <span>Miami</span>
              <span>·</span>
            ...
            <div className="editorial-label text-[#c4a265] text-[6px] md:text-[10px] leading-tight whitespace-nowrap">
