          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Link href="/yacht-rental-miami" className="group relative aspect-square overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <div className="flex justify-between items-center">
                  <div className="editorial-label text-white/70 text-[10px] border border-white/30 px-3 py-1">From $700</div>
            ...
            <Link href="/yacht-rental-miami" className="group relative aspect-square overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <div className="flex justify-between items-center">
                  <div className="editorial-label text-white/70 text-[10px] border border-white/30 px-3 py-1">From $1,250</div>
                  <div className="editorial-label text-white flex items-center gap-2">
                    <span>View Collection</span>
                    <span>→</span>
                  </div>
            ...
            <Link href="/yacht-rental-miami" className="group relative aspect-square overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <div className="flex justify-between items-center">
                  <div className="editorial-label text-white/70 text-[10px] border border-white/30 px-3 py-1">From $3,200</div>
                  <div className="editorial-label text-white flex items-center gap-2">
                    <span>View Collection</span>
                    <span>→</span>
                  </div>
