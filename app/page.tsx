...
export default function HomePage() {
  return (
    <div>
      ...
      <section className="bg-[#faf9f7] py-20 md:py-28" style={{ paddingTop: '80px', paddingBottom: '112px' }}>
        {/* Mobile: 80px (5rem), Desktop: 112px (7rem) */}
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          {/* Header */}
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8" style={{ marginBottom: '64px' }}>
      ...
      <section className="bg-[#0d0d0d]" style={{ paddingTop: '112px', paddingBottom: '112px' }}>
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
      ...
      <section className="bg-[#0d0d0d] border-t border-white/5" style={{ paddingTop: '80px', paddingBottom: '112px' }}>
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
      ...
      {/* Section 4: CTA */}
      <section className="relative" style={{ paddingTop: '112px', paddingBottom: '112px' }}>
        <div className="absolute inset-0">
          <img
      ...
      {/* Footer */}
      <footer className="bg-[#0f0f0f]" style={{ paddingTop: '80px', paddingBottom: '48px' }}>
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
