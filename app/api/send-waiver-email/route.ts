...
export async function POST(request: NextRequest) {
  try {
    ...
    for (const item of itemsWithWaivers) {
      ...
      // Format waiver as HTML
      const waiverHTML = generateWaiverHTML(item, waiver, customerInfo);
...
function generateWaiverHTML(item: any, waiver: any, customerInfo: any): string {
